...
const Footer = () => {
    return (
        <div>
            <footer className="footer font-mono px-10 py-8 uppercase mt-4 bg-base-200 text-base-content">
                <div>
                    <span className="footer-title">QUICK LINKS</span>
                    <Link to='/home' className="link link-hover">Home</Link> 
                    <Link to='/aboutus' className="link link-hover">About Us</Link> 
                    <Link to='/' className="link link-hover">Our Services</Link> 
                    <Link to='/' className="link link-hover">Our Doctors</Link> 
                  
                </div>
                <div>
                    <span className="footer-title">POPULAR LINKS</span>
                    <Link to='/' className="link link-hover">About us</Link> 
                    <Link to='/' className="link link-hover">Contact</Link> 
                    <Link to='/' className="link link-hover">Sing Up</Link> 
                    <Link to='/' className="link link-hover">Log In</Link> 
                </div>
                <div>
