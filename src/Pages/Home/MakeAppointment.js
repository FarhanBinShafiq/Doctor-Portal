    ...
    return (
        ...
        className='flex justify-center items-center'>
            ...
            <div className='flex-1 px-10 sm:px-12 sm:py-12'>
                  ...
                  <h3 className='text-xl my-4 text-white'>Make an Appoinment Today</h3>
                  ...
                  <button className="btn btn-primary my-8 text-white font-bold uppercase bg-gradient-to-r from-info to-primary ">Get Started</button>
            </div>
        </section>
    );
};
